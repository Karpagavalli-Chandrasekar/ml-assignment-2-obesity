...
XGBoost is a gradient boosting method that builds trees sequentially to correct errors from
previous trees. It often performs very strongly on structured/tabular datasets.
"""
...
def main() -> None:
    ...
    # Chosen hyperparameters (not defaults) to balance learning speed vs overfitting
    model = XGBClassifier(
        n_estimators=300,
        max_depth=5,
        learning_rate=0.05,
