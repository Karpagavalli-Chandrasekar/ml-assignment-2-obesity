...
Random Forest typically generalizes better than a single Decision Tree by averaging many trees.
This script trains a moderately regularized forest and prints a detailed evaluation summary.
"""
...
def evaluate_binary(y_true: pd.Series, y_prob: np.ndarray, threshold: float = THRESHOLD) -> None:
    """Print evaluation metrics using a fixed threshold."""
...
def main() -> None:
    ...
    # Hyperparameters chosen to balance performance and overfitting control
