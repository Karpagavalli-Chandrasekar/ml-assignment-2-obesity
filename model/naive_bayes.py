...
Naive Bayes is fast and simple, but it assumes conditional independence between features.
This script trains GaussianNB and prints a detailed evaluation summary.
"""
